...
# from conditional_musegan.utils import SignalGenerator, dilated_factor
...
def main(config: DictConfig) -> None:
    ...
    z_grid = scipy.stats.truncnorm.rvs(-2, 2, size=(np.prod(config.sample_grid), config.generator.latent_dim)).astype(np.float32)
